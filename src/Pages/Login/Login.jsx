...
import { sendUserData } from "@/Features/userSlice.js";
import { validationSchema, formValidation } from './validation';
...
const Login = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { resetForm }) => {
            try {
                await dispatch(sendUserData(values)).unwrap();
                navigate('/', { replace: true });
            } catch (error) {
    ...
    return (
        <div className="loginPage">
            <h2 className="title">Welcome<br /><span className="small">Help us Know You Better</span></h2>
